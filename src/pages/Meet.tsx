...
const Meet: React.FC = () => {
  ...
  const meetings = [
    { id: 1, title: '취창업 전시케어', date: '오늘', time: '오후 4:00', participants: 24, host: '카페 창업', area: '서초동' },
    { id: 2, title: '피나게 가보자구', date: '오늘', time: '오후 4:00', participants: 24, host: '만남', area: '잠실동' },
    { id: 3, title: '취창업 전시케어', date: '오늘', time: '오후 4:00', participants: 24, host: '카페 창업', area: '서초동' },
    { id: 4, title: '취창업 전시케어', date: '오늘', time: '오후 4:00', participants: 24, host: '카페 창업', area: '서초동' },
    { id: 5, title: '취창업 전시케어', date: '오늘', time: '오후 4:00', participants: 24, host: '카페 창업', area: '서초동' },
  ];

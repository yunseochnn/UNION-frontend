...
const MeetHeader: React.FC<MeetHeaderProps> = ({ sortBy, setSortBy }) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2 text-sm text-gray-600 border-b relative">
        <button 
        ...
        <button className="border border-gray-300 rounded-full px-3 py-1 flex items-center">
